...
public class TriangularNumber {
	...
	/**
	 * This method will calculate the first triangle number which has over five hundred divisors  
	...
	public int countDivisor(int divisorCount) {
		...
		//divisor count should be less than or equal to 500 and greater than 0.
